...
class OCR():
    ...
    def convert(self, image, threshold=4):
        ...
        img.save('after_depoint.jpg')
        __image = Image.open('after_depoint.jpg')
        text = pytesseract.image_to_string(__image)
        # print(text)
        # os.remove('after_depoint.jpg')
        return text

if __name__ == "__main__":
    TEST = OCR(tesseract_cmd='/opt/homebrew/bin/tesseract')
    text = TEST.convert('storage/qasp.png')
    print(text)
